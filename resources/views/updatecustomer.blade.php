		...
		<form method="post" action="/customerupdate">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<label class="pure-material-textfield-outlined">
							<input type="text" name="name" value="{{$data['customer_name']}}" dir="rtl" id="textArea" placeholder=" ">
					...
					<div class="col-sm-6">
						...
						<label class="pure-material-textfield-outlined">
							<input type="number" name="mobile" value="{{$data['customer_mobile']}}" placeholder=" ">
				...
				<div class="row">
					<div class="col-sm-6">
						<label class="pure-material-textfield-outlined">
							<input type="email" name="email" value="{{$data['customer_email']}}" placeholder=" ">
					...
					<div class="col-sm-6">
						<label class="pure-material-textfield-outlined">
							<input type="text" name="address" value="{{$data['customer_address']}}" placeholder=" ">
				...
				<div class="row">
					<div class="col-sm-6">
						<label class="pure-material-textfield-outlined">
							<input type="text" name="state" value="{{$data['customer_state']}}" placeholder=" " >
							<span>State*</span>
						</label>
					...
					<div class="col-sm-6">
						<label class="pure-material-textfield-outlined">
							<input type="text" name="pincode" value="{{$data['customer_pincode']}}" placeholder=" " >
							<span>Pincode*</span>
						</label>
				...
				<div class="row">
					<button type="submit" name="detailsupdate" style="width:86%; margin-top:20px; margin-left:15px;" class="btn btn-outline-dark btn-lg btn-block"><b>UPDATE</b></button>
